...
public class ExecutorManagerTest {
  ...
  private ExecutorManager createMultiExecutorManagerInstance(
    ...
    loader.addExecutor("localhost", 12345, Constants.ConfigurationKeys.DEFAULT_EXECUTOR_POOL_NAME);
    loader.addExecutor("localhost", 12346, Constants.ConfigurationKeys.DEFAULT_EXECUTOR_POOL_NAME);
  ...
  public void testMultipleExecutorScenario() throws ExecutorManagerException {
    ...
    props.put(ExecutorManager.AZKABAN_USE_MULTIPLE_EXECUTORS, "true");
    ExecutorLoader loader = new MockExecutorLoader();
    Executor executor1 = loader.addExecutor("localhost", 12345, Constants.ConfigurationKeys.DEFAULT_EXECUTOR_POOL_NAME);
    Executor executor2 = loader.addExecutor("localhost", 12346, Constants.ConfigurationKeys.DEFAULT_EXECUTOR_POOL_NAME);
  ...
  public void testSetupExecutorsSucess() throws ExecutorManagerException {
    ...
    Executor executor2 = loader.addExecutor("localhost", 12346, Constants.ConfigurationKeys.DEFAULT_EXECUTOR_POOL_NAME);
    Executor executor3 = loader.addExecutor("localhost", 12347, Constants.ConfigurationKeys.DEFAULT_EXECUTOR_POOL_NAME);
